...
const Navigation = () => {
  ...
  // Scroll suave con compensación y delay para mobile
  const scrollToSection = (id: string) => {
    ...
    setTimeout(() => {
      const navbarHeight = 80; // ajusta según tu diseño
      const top =
        element.getBoundingClientRect().top + window.scrollY - navbarHeight;
      window.scrollTo({ top, behavior: "smooth" });
    }, 300); // coincide con la animación del menú
  };
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="lg:hidden overflow-hidden bg-background/95 backdrop-blur-md shadow-md rounded-lg mt-2 z-40"
            >
